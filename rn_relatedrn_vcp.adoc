...
summary: NetApp HCI または SolidFire オールフラッシュアレイ環境に含まれる製品またはコンポーネントのリリースノートへのリンクを入手できます。 
...
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2886996["NetApp Element ソフトウェア12.8リリースノート"^]新規_
...
== VMware vCenter Server向けNetApp Element プラグイン

* https://library.netapp.com/ecm/ecm_download_file/ECMLP3330676["『 vCenter Plug-in 5.4 Release Notes 』を参照してください"^]新規_
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3316480["vCenter Plug-in 5.3リリースノート"^]
* https://library.netapp.com/ecm/ecm_download_file/ECMLP2886272["vCenter Plug-in 5.2リリースノート"^]
...
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.146.html["Compute Firmware Bundle 2.146 リリースノート"^]
