...
* https://docs.netapp.com/us-en/hci/docs/rn_compute_firmware_2.146.html["Compute Firmware Bundle 2.146 リリースノート"^] _ 新規 _
...
* https://docs.netapp.com/us-en/hci/docs/rn_storage_firmware_2.146.html["ストレージファームウェアバンドル 2.146 リリースノート"^] _ 新規 _
