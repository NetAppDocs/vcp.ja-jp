...
[role="lead"]
NetApp Element Plug-in for VMware vCenter Serverのバージョン5.4より前のリリースのドキュメントも用意されています。


NOTE: link:index.html["マニュアルへのリンク"]Element vCenterプラグイン5.4向けのバージョンには、5.3、5.2、5.1、5.0、4.10、4.9、4.8、4.7、4.6も含まれています。
...
| 5.3 | https://library.netapp.com/ecm/ecm_download_file/ECMLP3316480["PDF"^] | https://library.netapp.com/ecm/ecm_download_file/ECMLP3316480["2.25.42"^] | link:index.html["リンク"] 
