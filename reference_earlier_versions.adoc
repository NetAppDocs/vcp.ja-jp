...
[role="lead"]
ドキュメントは、バージョン4.9より前のNetApp Element Plug-in for vCenter Serverのリリースでも参照できます。


NOTE: これ link:index.html["マニュアルへのリンク"] バージョン4.9のNetApp Element Plug-in for vCenter Serverには、バージョン4.6、4.7、および4.8も含まれています。
