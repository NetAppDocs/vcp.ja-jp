...
[role="lead"]
NetApp Element Plug-in for vCenter Server をアップグレードする手順については、環境に応じた手順に従ってください。NetApp Element vCenterプラグイン5.3は、ElementおよびNetApp HCIリリースに含まれていませんが、管理サービスバンドルの一部として提供されています。
