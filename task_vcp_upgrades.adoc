...
[role="lead"]
ご使用の環境に対応する手順に従って、NetApp Element Plug-in for VMware vCenter Serverをアップグレードできます。Element vCenter Plug-in 4.10は、管理サービスのバンドルの一部としてElementソフトウェアとNetApp HCI のリリースに含まれていません。
